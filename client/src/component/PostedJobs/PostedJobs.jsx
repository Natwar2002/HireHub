...
import { useGetHRJobs } from "../../hooks/jobPost/useGetHRJobs";
          ...
          <div className="space-y-4">
            {jobs.map((job) => (
              <div
                ...
                className={`cursor-pointer border flex items-center gap-6 p-4 rounded-xl hover:bg-gray-800 transition ${
              ...
              <div className="grid gap-6">
                <div>
                  ...
                  <ul className="list-disc list-inside text-gray-300 space-y-1">
                    <li>{selectedJob.jobDescription}</li>
                  </ul>
                </div>
 ...
 *     {
      ...
      jobDescription: "Build responsive UI",
      tags: ["#react", "#frontend"],
    ...
    },
    {
      ...
      jobDescription: "Design REST APIs",
      tags: ["#node", "#backend"],
