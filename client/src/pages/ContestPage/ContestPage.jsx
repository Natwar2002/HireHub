...
const quizCategories = [
  ...
  },
  {
    ...
    title: "Backend Quiz",
    icon: (
      <SiNodedotjs className="text-green-500 dark:text-green-400 text-4xl" />
    ),
    questions: Math.floor(Math.random() * 11) + 15,
    duration: `${Math.floor(Math.random() * 6) + 5} min`,
  ...
  },
  {
    ...
    icon: (
      <SiReactrouter className="text-indigo-500 dark:text-indigo-400 text-4xl" />
    ),
    questions: Math.floor(Math.random() * 11) + 15,
    duration: `${Math.floor(Math.random() * 6) + 5} min`,
    ...
    <section className="min-h-screen bg-background text-foreground px-6 py-16">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          Get recruiters' attention by completing quick tech contests – showcase
